# Generated by Django 2.0 on 2018-07-19 04:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='category.Department')),
                ('fab', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='category.Fabric')),
        ...
        migrations.AddField(
            model_name='person',
            name='sect',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='category.Sections'),
        ),
        migrations.AddField(
            model_name='person',
            name='subcat',
        ...
        migrations.AddField(
            model_name='person',
            name='subsect',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='category.Subsection'),
        ),
        migrations.AddField(
            model_name='person',
            name='was',
